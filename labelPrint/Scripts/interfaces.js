...
function showDlgPrint(idModel, idSideL, idSideR, idflx, idVol, idColor, idRev, num_lbls, printMode) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            //    if (printMode === "1" && idModel != 153 && idModel != 155 && idModel != 156 && idModel != 92 && idModel != 203) {
            //        printLblSide(idModel, idSideL, idflx, idVol, idColor, idRev, 10, $("#cmbPrinters").val(),"TEST");
            //        if (idSideL === "1") {
            //            alert("Se imprimiran las etiquetas del lado RH");
            //            printLblSide(idModel, idSideR, idflx, idVol, idColor, idRev, 10, $("#cmbPrinters").val(), "TEST");
            //        }
            //    }
            //    else


                    //printLbl(idModel, idSideL, idSideR, idflx, idVol, idColor, idRev, 10, $("#cmbPrinters").val(), printMode);
                    //printLblTest(idModel, idSideL, idSideR, idflx, idVol, idColor, idRev, $("#cmbPrinters").val(), "1");
            });
